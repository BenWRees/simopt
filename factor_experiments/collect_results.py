...
def collect_results(experiment_dir: Path) -> pd.DataFrame:
    ...
    for pickle_file in experiment_dir.glob("*.pickle"):
        try:
            with open(pickle_file, "rb") as f:  # noqa: PTH123
                pickle.load(f)
...
def main() -> None:  # noqa: D103
    ...
    experiment_names = [
        "subspace_dimensions_san",
        "subspace_dimensions_dynamnews",
        "subspace_dimensions_network",
        "subspace_dimensions_rosenbrock",
        "poly_basis_san",
        "poly_basis_dynamnews",
        "poly_basis_network",
        "poly_basis_rosenbrock",
    ]
