...
class GaussianProcess(BaseFunction):
    ...
    * diag: diagonal	
    ...
    def fit(self, X, y, L0=None):
        ...
        elif self.structure == "scalar_mult" or self.structure == "const":
    ...
    def _fit(self, ell0):
        ...
        self.alpha, self.beta = self._log_marginal_likelihood(
            ell, return_obj=False, return_grad=False, return_alpha_beta=True
        )
        self._ell = ell
