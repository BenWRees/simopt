...
def run_solver(  # noqa: D103
    ...
    # solver_factors = {'geometry instance': 'AstroDFGeometry', 'sampling rule':
...
def experiment_1() -> None:  # noqa: D103
    run_solver(
        "ASTRODF_FACSIZE", "ASTRODF", "FACSIZE-1", {"crn_across_solns": False}, {}
    )
    ...
    run_solver(
        ...
        "OMoRF",
        "FACSIZE-1",
        {"subspace dimension": 7, "crn_across_solns": False},
        {},
    )

    run_solver("STRONG_FACSIZE", "STRONG", "FACSIZE-1", {"crn_across_solns": True}, {})
    run_solver(
        "STRONG_DYNAMNEWS", "STRONG", "DYNAMNEWS-1", {"crn_across_solns": True}, {}
    )
    run_solver(
        "STRONG_ROSENBROCK", "STRONG", "ROSENBROCK-1", {"crn_across_solns": True}, {}
    )
    run_solver(
        "STRONG_ZAKHAROV", "STRONG", "ZAKHAROV-1", {"crn_across_solns": True}, {}
    )

    run_solver(
        "RNDSRCH_FACSIZE", "RNDSRCH", "FACSIZE-1", {"crn_across_solns": False}, {}
    )
    run_solver(
        "RNDSRCH_DYNAMNEWS", "RNDSRCH", "DYNAMNEWS-1", {"crn_across_solns": False}, {}
    )
    run_solver(
        "RNDSRCH_ROSENBROCK", "RNDSRCH", "ROSENBROCK-1", {"crn_across_solns": False}, {}
    )
    run_solver(
        "RNDSRCH_ZAKHAROV", "RNDSRCH", "ZAKHAROV-1", {"crn_across_solns": False}, {}
    )
...
def experiment_2() -> None:  # noqa: D103
    # for i in range(1,10) :
    # 	name = 'ASTROMoRF_on_subspace_dim_' + str(i)
    # run_solver(name,'ASTROMoRF', 'DYNAMNEWS-1',{'crn_across_solns': False,
    # 'old_implementation': True, 'subspace dimension':i,
    # 'performance_benchmarking_flag': False}, {})
    run_solver(
        "ASTROMoRF_on_subspace_dim_6",
        "ASTROMoRF",
        "DYNAMNEWS-1",
        {
            "crn_across_solns": False,
            ...
            "performance_benchmarking_flag": True,
        },
        {},
    )
    run_solver(
...
# # run_solver('ASTROMoRF', 'FACSIZE-1',{'subspace dimension': 7,'crn_across_solns':
# False, 'sampling rule': sampling_rule}, {})
# run_solver(exp_name, 'ASTROMoRF', 'ROSENBROCK-1',{'subspace dimension':
# 5,'crn_across_solns': True, 'sampling rule': sampling_rule}, {})
# # run_solver('ASTROMoRF', 'ZAKHAROV-1',{'subspace dimension': 7,'crn_across_solns':
# False, 'sampling rule': sampling_rule}, {})
# # run_solver('ASTROMoRF', 'DYNAMNEWS-1',{'subspace dimension': 7,'crn_across_solns':
# False, 'sampling rule': sampling_rule}, {})
...
# # run_solver('ASTROMoRF', 'FACSIZE-1',{'subspace dimension': 7,'crn_across_solns':
# True, 'polynomial basis': poly}, {})
# run_solver(exp_name, 'ASTROMoRF', 'ROSENBROCK-1',{'subspace dimension':
# 5,'crn_across_solns': True, 'polynomial basis': poly}, {})
# # run_solver('ASTROMoRF', 'ZAKHAROV-1',{'subspace dimension': 7,'crn_across_solns':
# True, 'polynomial basis': poly}, {})
# # run_solver('ASTROMoRF', 'DYNAMNEWS-1',{'subspace dimension': 7,'crn_across_solns':
# True, 'polynomial basis': poly}, {})
