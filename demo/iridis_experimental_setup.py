...
-------
This script allows for a problem-solver pair to be run and logged into a pickle file.
This allows us to run multiple processes on iridis of each problem solver pair
"""
...
def run_problem_solver_pair(solver_name: str, problem: ProblemLike) -> None:  # noqa: D103
    print(f"Testing solver {solver_name} on problem {problem.name}.")
    # Lookup table for subspace dims
    subspace_dims = {
        "ASTROMoRF": {"DYNAMNEWS-1": 1, "ROSENBROCK-1": 5, "ZAKHAROV-1": 8},
        "OMoRF": {"DYNAMNEWS-1": 1, "ROSENBROCK-1": 1, "ZAKHAROV-1": 7},
    }
    ...
    if solver_name == "ASTROMoRF" or solver_name == "OMoRF":
        ...
        solver_fixed_factors = {
            "subspace dimension": subspace_dim,
    ...
    myexperiment = ProblemSolver(
        solver_name, problem=problem, solver_fixed_factors=solver_fixed_factors
    )
...
def main() -> None:  # noqa: D103
    ...
    problem_names = ["DYNAMNEWS-1", "ROSENBROCK-1", "ZAKHAROV-1"]
    ...
    # # elif problem_name == 'ROSENBROCK-1' or problem_name == 'ZAKHAROV-1' : #case of
    # zakharov and rosenbrock
    # 		else :
    # 			model_fixed_factors = {'variance': 5.0}
    # 		# else :
    # 		# 	model_fixed_factors = {}

    # problem = problem_directory[problem_name](fixed_factors={'budget': 10000},
    # model_fixed_factors=model_fixed_factors)

    # 		for solver_name in solver_names :
    # 			futures.append(executor.submit(
    # 			    run_problem_solver_pair,
    # 			    solver_name, problem))
    ...
    for problem_name in problem_names:
        ...
        problem = problem_directory[problem_name](
            fixed_factors={"budget": 10000}, model_fixed_factors=model_fixed_factors
        )
...
# problem = problem_directory[problem_name](fixed_factors={'budget': 500},
# model_fixed_factors=model_fixed_factors)
