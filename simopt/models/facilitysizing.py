    ...
    def specifications(cls) -> dict[str, dict]:
        return {
            ...
            "cov": {
                ...
                "datatype": list,
                "default": [
                    [1500, 1200, 1100, 1000, 900, 1100, 1200, 1300, 1250, 1150],
                    [1200, 1500, 1250, 1100, 1000, 1050, 1150, 1200, 1100, 1000],
                    [1100, 1250, 1600, 1200, 1050, 950, 1000, 1100, 1200, 1300],
                    [1000, 1100, 1200, 1550, 1100, 1000, 950, 1000, 1050, 1150],
                    [900, 1000, 1050, 1100, 1500, 1200, 1100, 1000, 950, 1000],
                    [1100, 1050, 950, 1000, 1200, 1600, 1250, 1200, 1150, 1100],
                    [1200, 1150, 1000, 950, 1100, 1250, 1500, 1300, 1200, 1100],
                    [1300, 1200, 1100, 1000, 1000, 1200, 1300, 1600, 1350, 1200],
                    [1250, 1100, 1200, 1050, 950, 1150, 1200, 1350, 1550, 1250],
                    [1150, 1000, 1300, 1150, 1000, 1100, 1100, 1200, 1250, 1500]
                    ]
            },
            "capacity": {
                "description": "capacity",
                "datatype": list,
                "default": [150, 300, 400, 200, 250, 350, 300, 400, 450, 500],
            },
            "n_fac": {
