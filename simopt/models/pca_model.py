...
class PCAModelConfig(BaseModel):
    """Configuration model for PCA Model.
...
class PCAModel(Model):
    ...
    class_name_abbr: ClassVar[str] = "PCA"
    class_name: ClassVar[str] = "PCA Model"
    config_class: ClassVar[type[BaseModel]] = PCAModelConfig
    ...
    def function_to_eval(self, x: float) -> float:  # noqa: D102
        return x**2
...
class PCAProblemConfig(BaseModel):
    """Configuration model for PCA Problem."""
...
class PCAProblem(Problem):
    """PCA Problem - minimizes a deterministic function evaluated with noise."""

    class_name_abbr: ClassVar[str] = "PCA-1"
    class_name: ClassVar[str] = "PCA Problem"
    config_class: ClassVar[type[BaseModel]] = PCAProblemConfig
    model_class: ClassVar[type[Model]] = PCAModel
