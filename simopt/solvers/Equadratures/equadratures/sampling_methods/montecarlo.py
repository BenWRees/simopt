...
class Montecarlo(Sampling):
    """The class defines a Montecarlo object. Samples are generated from the given.
    ...
    def __init__(self, parameters, basis, corr=None, oversampling=7.0) -> None:  # noqa: ANN001, D107
        ...
        super().__init__(self.parameters, self.basis, self.points)

    def _set_points(self, number_of_samples, corr=None):  # noqa: ANN001, ANN202
