...
def main():
    output_dir = Path("/Users/benjaminrees/Desktop/simopt/HPC_code/generated_slurm_files")
    
    # List of experiment directories
    experiment_names = ['subspace_dimensions_facsize', 'subspace_dimensions_dynamnews', 'subspace_dimensions_network', 'poly_basis_facsize', 'poly_basis_dynamnews', 'poly_basis_network']
